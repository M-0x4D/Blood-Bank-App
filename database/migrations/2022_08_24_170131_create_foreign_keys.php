...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('client_governrate', function(Blueprint $table) {
			$table->foreign('client_id')->references('id')->on('clients')
						->onDelete('no action')
						->onUpdate('no action');
		});
	...
	public function down()
	{
		...
		Schema::table('client_governrate', function(Blueprint $table) {
			$table->dropForeign('client_governrate_client_id_foreign');
		});
		Schema::table('client_governrate', function(Blueprint $table) {
			$table->dropForeign('client_governrate_governrate_id_foreign');
		});
		Schema::table('posts', function(Blueprint $table) {
